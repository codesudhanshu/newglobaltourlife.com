...
export default function BlogDetailPage() {
  ...
  const color = blog ? (CATEGORY_COLORS[blog.category] || "#64748b") : "#f97316";
      ...
      <div className="bg-[#0f172a] py-14">
        <div className="container-custom max-w-3xl">
          <div className="flex items-center gap-2 text-sm text-gray-400 mb-6">
            ...
            <span>/</span>
            <Link href="/blogs" className="hover:text-[#f97316]">Blog</Link>
            <span>/</span>
          ...
          <div className="flex items-center gap-5 text-gray-400 text-sm">
            <span className="flex items-center gap-1.5"><User size={14} className="text-[#f97316]" /> {blog.author}</span>
            {dateStr && <span className="flex items-center gap-1.5"><Calendar size={14} className="text-[#f97316]" /> {dateStr}</span>}
          </div>
        </div>
      </div>
      ...
      <main className="bg-gray-50 py-12">
        <div className="container-custom max-w-3xl">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <Link
              href="/blogs"
              className="inline-flex items-center gap-2 text-[#f97316] font-semibold hover:gap-4 transition-all"
            >
