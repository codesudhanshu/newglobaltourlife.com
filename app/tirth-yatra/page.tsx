    ...
    <>
      ...
      <div className="bg-[#0A65AB] py-14">
        <div className="container-custom">
          ...
          <span className="text-xs bg-[#0A65AB] text-white px-3 py-1 rounded-full font-semibold mb-4 inline-block">🛕 Pilgrimage Tours</span>
          <h1 className="text-4xl lg:text-5xl font-extrabold text-white mb-4 leading-tight">
            Sacred <span className="text-[#0A65AB]">Tirth Yatra</span> Packages
          </h1>
        ...
        <div className="container-custom pt-10">
          {loading ? (
            <div className="flex justify-center py-20">
              <div className="w-10 h-10 border-4 border-[#0A65AB] border-t-transparent rounded-full animate-spin" />
            </div>
          ) : items.length === 0 ? (
            <div className="text-center py-20 bg-[#1e293b] rounded-2xl border border-slate-700">
              ...
              <button
                ...
                className="bg-[#0A65AB] hover:bg-[#0a1120] text-white font-bold px-6 py-3 rounded-xl transition-colors"
              >
                Enquire Now
              </button>
            </div>
          ...
          <div className="mt-12 bg-gradient-to-r from-[#0A65AB] to-cyan-600 rounded-2xl p-10 text-center">
            ...
            <button
              ...
              className="bg-white text-[#0A65AB] font-bold px-8 py-3 rounded-xl hover:bg-amber-50 transition-colors"
            >
