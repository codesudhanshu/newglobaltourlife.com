  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-gray-900">Edit: {form.name}</h1>
      </div>
        ...
        <div className="lg:col-span-2 space-y-5">
          <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
            <div>
              ...
              <input required value={form.name} onChange={(e) => set("name", e.target.value)} placeholder="e.g. Goa, Dubai" className={inp} />
            </div>
            ...
            <div>
              ...
              <textarea value={form.description} onChange={(e) => set("description", e.target.value)} rows={3} placeholder="Short description..." className={`${inp} resize-none`} />
            </div>
