    ...
    fetch(`/api/cars/${id}`, { headers: authHeaders() })
      ...
      .then((data) => {
        setForm({
          ...
          schemaJsonLd: data.schemaJsonLd || "", schemaBlocks: data.schemaBlocks || [],
        });
        setFetching(false);
      })
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-gray-900">Edit Car</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <p className="text-gray-400 text-xs mb-3">First image = cover. Add multiple for gallery view.</p>
            {token && (
              <MultiImageUpload
                values={form.images}
