  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-8">
        ...
        <h1 className="text-2xl font-extrabold text-white">Add New Car</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="bg-[#1e293b] rounded-xl border border-slate-700 p-6">
            ...
            <p className="text-gray-500 text-xs mb-3">First image = cover photo. Add multiple for gallery view on detail page.</p>
            {token && (
              <MultiImageUpload
                values={form.images}
