        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="col-span-2">
              ...
              <input value={form.name} onChange={(e) => field("name", e.target.value)} placeholder="e.g. Grand Palace Hotel" className={inp} />
            </div>
            <div>
              <label className={lbl}>City *</label>
              <input value={form.city} onChange={(e) => field("city", e.target.value)} placeholder="Indore" className={inp} />
            </div>
            <div>
            ...
            <div className="col-span-2">
              ...
              <input value={form.location} onChange={(e) => field("location", e.target.value)} placeholder="e.g. Near Airport, MG Road" className={inp} />
            </div>
          </div>

          <div>
            <label className={lbl}>Description</label>
            <textarea value={form.description} onChange={(e) => field("description", e.target.value)} rows={3} placeholder="Describe the hotel..." className={`${inp} resize-none`} />
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-200 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input type="number" value={form.pricePerNight} onChange={(e) => field("pricePerNight", e.target.value)} placeholder="5000" className={inp} />
            </div>
            <div>
